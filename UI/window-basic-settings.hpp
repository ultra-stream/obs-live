...
private slots:
	...
	void on_audio_advanced_settins_clicked();
	void on_show_passkey_button_clicked();
	void on_rematrix_button_clicked();
...
private slots:
	...
	void on_recordingFilePathLineEdit_clicked();
	...
	void ChannelChangedWarning(int idx);
...
public:
	...
	~OBSBasicSettings();
        ...
        inline bool CredsChanged() const
        {
                return slCredsChanged;
        }
};
