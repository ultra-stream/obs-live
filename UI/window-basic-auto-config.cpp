...
void AutoConfig::SaveSettings()
{
	...
	config_set_string(main->Config(), "SimpleOutput", "RecQuality",
			  quality);
	config_set_int(App()->GlobalConfig(), "Video", "BaseCX", baseResolutionCX);
	config_set_int(App()->GlobalConfig(), "Video", "BaseCY", baseResolutionCY);
	config_set_int(App()->GlobalConfig(), "Video", "OutputCX", idealResolutionCX);
	config_set_int(App()->GlobalConfig(), "Video", "OutputCY", idealResolutionCY);
