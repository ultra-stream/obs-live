...
class OBSBasic : public OBSMainWindow {
	...
	static VolControl* currentActiveVolControl;
...
private:
    ...
    OBSSceneItem currentSceneItem = nullptr;
    QComboBox *m_transitions = new QComboBox();
	...
	std::string patronJson;
        ...
        QPointer<QTimer> userBalancePollTimer;

    OBSSceneItem rightClickedItem;
    bool isStreamingStarting = false;
	...
	QLabel* onlyAudioLabel;

	void centerOnlyAudioLabel();
...
public slots:
    ...
    void revealFileInDefaultFileSystemViewer(const QString &path);
...
private:
	...
	void SetStreamingSettingsControlsEnabled(bool enabled);
...
public:
	...
	void CreateMouseRightClickSourceMenu(OBSSceneItem item);
...
private slots:
	...
	void pollSEUserStatusText();
        void userStatusReplyReady(QNetworkReply *reply);
	void selectSourceButtonPressed();
	void clearSourcesButtonPressed();
	void visitGatewayButtonPressed();

	void on_action_about_triggered();
	void on_recording_checkbox_state_changed(int state);
